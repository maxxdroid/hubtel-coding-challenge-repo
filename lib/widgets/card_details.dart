...
class CardDetails extends StatelessWidget {
  ...
  const CardDetails({required this.name, required this.status, required this.type, required this.asset,required this.message ,super.key});
              ...
              child: Row(
                ...
                children: [
                  ...
                  Column(
                    children: [
                      Card(
                        color: Colors.green[100]?.withOpacity(.6),
